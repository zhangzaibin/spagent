---
name: pi3x
title: Pi3X - Enhanced 3D Reconstruction
summary: >
  Enhanced 3D reconstruction (Pi3X) with smoother point clouds and
  approximate metric scale. View scenes from any angle.
tool_name: pi3x_tool
---

## Pi3X - Enhanced 3D Reconstruction Tool

Upgraded 3D reconstruction with smoother point clouds, flexible conditioning,
and approximate metric scale.
...
<tool_call>
{"name": "pi3x_tool", "arguments": {"image_path": "<image_path>", "azimuth_angle": "<azimuth_angle>", "elevation_angle": "<elevation_angle>", "rotation_reference_camera": "<rotation_reference_camera>", "camera_view": "<camera_view>"}}
</tool_call>

### Call Format (Training)
<tool_call>
{"name": "pi3x_tool", "arguments": {"image_path": "<image_path>", "azimuth_angle": "<azimuth_angle>", "elevation_angle": "<elevation_angle>"}}
</tool_call>

### Output
Returns a rendered 3D point cloud image from the specified viewpoint with enhanced quality.
