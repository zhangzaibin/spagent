...
def main():
    args = RLHFArguments(
        rlhf_type="grpo",
        model="/ubuntu/pretrained_weights/Qwen3-VL-2B-Instruct",
        external_plugins="/ubuntu/project/spagent/plugin/plugin.py",
        multi_turn_scheduler="spagent_tool_call_scheduler",
        max_turns=3,
        reward_funcs=["external_r1v_acc", "external_multiturn_format"],
        train_type="lora",
        torch_dtype="bfloat16",
        dataset="/ubuntu/project/spagent/dataset/crossviewQA_train_rl_100.jsonl",
        ...
        system="/ubuntu/project/spagent/train/system_prompt/system_prompt_grpo.txt",
        deepspeed="zero2",
