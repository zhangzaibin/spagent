...
| **InfiniDepth** | 2D/3D | High-resolution Depth Estimation | Local server (20037) | Estimate relative depth from a single RGB image with optional point cloud export |
