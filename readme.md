...
| **SAM3** | 2D/Video | Text-Prompt Segmentation | Local server (20035) | Segment Anything Model 3 text-prompt concept segmentation for images and videos |
