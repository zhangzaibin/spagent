...
# 添加文件处理器
file_handler = logging.FileHandler('assets/sam_client.log')
    ...
    def infer(self, image_path, prompts=None):
        ...
        try:
            ...
            if result.get('success'):
                ...
                output_filename = f"assets/mask_{input_filename}"
                ...
                # 保存可视化结果
                vis_filename = f"assets/vis_{input_filename}"
...
def main():
    ...
    logger.info("\n=== 处理图片示例 ===")
    # 使用点提示
    image_path = "assets/test.jpg"  # 替换为实际的测试图片路径
    prompts = {
