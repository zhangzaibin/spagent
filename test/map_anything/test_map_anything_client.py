...
def test_map_anything_client_real() -> None:
    ...
    client = MapAnythingClient(server_url=server_url, timeout=1800)
    ...
    print("Health:", health)
    print("Inference output_dir:", result["output_dir"])
    print("Inference num_views:", result["num_views"])
    print("Inference summaries:", result["summaries"])